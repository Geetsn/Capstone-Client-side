  ...
  return( 
    ...
    <div className='shopping-cart'>
          ...
          <div className='shopping-cart__container'>
            ...
            <img src={`http://localhost:8080/${item.image}`} alt="img" className='shopping-cart__img'/>
        ...
        <div className='containerTwo'>
          ...
          <div lassName='containerTwo__price'>
            ...
            <Btn className='btn_back' onClick={() => handleNavigateToProducts()} type="button" text='Back'/>
          </div>
        </div>
